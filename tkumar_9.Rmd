...
Please note that we have already removed or made the value of y2p because for increase in value more than 75M, Thus increase in amount in expected but not decrease. Thus, y2p=0. 
...
// Constraints
6 x1 + 4 x2 + 5 x3 + y2n = 75;
8 x1 + 7 x2 + 5 x3 + y1p - y1n = 50;
20 x1 + 15 x2 + 25 x3 = P;
...
get.variables(mx)
```
Objective function value is 768.75 which is overall profit of the company 

Rate of production of Product 1 = 0
Rate of production of Product 2 = 18.75
Rate of production of Product 3 = 0
